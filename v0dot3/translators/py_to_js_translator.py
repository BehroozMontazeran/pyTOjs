...
class PyTranslator:
    ...
    def translate_module_to_js(self, module_signature, dependencies_signature, module_elements_signature):
        ...
        if dependencies_signature and module_elements_signature and module_signature:
            ...
            data = {'number_of_classes': len(module_signature), 'python_module': module}
